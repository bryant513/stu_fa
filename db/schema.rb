...
ActiveRecord::Schema.define(:version => 20130517194001) do

  create_table "admin_permissions", :force => true do |t|
    t.string "resource",                          :null => false
    t.string "can",                               :null => false
    t.string "visible_fields", :default => "all", :null => false
  end

  create_table "admin_permissions_admin_roles", :force => true do |t|
  ...
  create_table "admin_roles_admin_users", :force => true do |t|
    t.integer "admin_role_id"
